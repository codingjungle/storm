...
class Database
{
    ...
    protected function unapprovedComments(): array
    {
        return $this->buildDefinition('unapproved_comments', 'Unapproved comments.', 'INT', 11, true, 0);
    }

    protected function hiddenComments(): array
    {
        return $this->buildDefinition('hidden_comments', 'Hidden comments.', 'INT', 11, true, 0);
    }
    ...
    {
        return $this->buildDefinition('is_anon', 'anon field.', 'TINYINT', 3, true);
    }

    protected function lastCommentAnon(): array
    {
        return $this->buildDefinition('last_comment_anon', 'last_comment_anon field.', 'TINYINT', 3, true);
    }
