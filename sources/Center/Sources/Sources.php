...
//            'link' => (string) Url::internal(
//                'app=storm&module=developer&controller=sources&appKey=' . Request::i()->appKey
//            ),
//            'id' => 'adminMenu_button',
//            'data' => [
//                'ipsDialog' => 1,
...
//            'title' => 'dtdevplus_dev',
//            'link' => (string) Url::internal(
//                'app=storm&module=developer&controller=dev&appKey=' . Request::i()->appKey
//            ),
...
//'caches_enabled',
    ...
    protected function elItemTraits(): void
    {
        ...
        } elseif ($this->type === 'comment' || $this->type === 'review') {
            $traits = [
                Anonymous::class => Anonymous::class,
                EditHistory::class => EditHistory::class,
                Helpful::class => Helpful::class,
