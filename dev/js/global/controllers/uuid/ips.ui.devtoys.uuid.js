;( function($, _, undefined){
    "use strict";
    ips.createModule('ips.ui.devtoys.uuid', () => {
        /**
        ...
        ips.ui.registerWidget( 'devtoysuuid', ips.ui.devtoys.uuid, [] );
        ...
        let ajax = ips.getAjax(),
            ...
            _generate = e => {
                let form = elem.find('form:first'),
                    ...
                    action = ips.getSetting('baseURL')+'?app=devtoys&module=general&controller=toys&do=uuid';
                ajax({
                    type: "POST",
                    url: action,
                    data:values,
