;(function ($, _, undefined) {
    "use strict";
    ips.createModule('ips.ui.storm.numbers', () => {
        /**
        ...
        ips.ui.registerWidget('stormdevtoysnumbers', ips.ui.storm.numbers, []);
        ...
        let ajax = ips.getAjax(),
            ...
            _process = (e) => {
                let target = $(e.currentTarget),
                    ...
                    number = target.val(),
                    url = ips.getSetting('baseURL') + 'index.php?app=storm&module=other&controller=toys&do=numbers&type=' + type + '&number=' + number;
                ajax({
                    type: "GET",
                    url: url,
                    bypassRedirect: true,
